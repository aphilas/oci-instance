output "public_ip" {
  ...
  value       = oci_core_instance.spade-instance.public_ip
}
...
output "ssh_command" {
  ...
  value       = "ssh -i ${var.ssh_private_key_file} -p ${local.ssh_port} ubuntu@${oci_core_instance.spade-instance.public_ip}"
}
